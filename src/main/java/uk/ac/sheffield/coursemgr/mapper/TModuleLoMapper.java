...
public interface TModuleLoMapper {
    ...
    //select all skills which contribute to all los
    ...
    //select all knowledge which contribute to all los
    List<TProgramKnowledge> selectLoToKnowledge();

    //select all assessments which contribute to this lo
    List<TModuleAssessment> selectAssessments(Long moduleLoId);

    //select all contents which contribute to all lo
    List<TModuleContent> selectContents(Long moduleLoId);
