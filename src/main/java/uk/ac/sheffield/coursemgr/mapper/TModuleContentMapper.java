...
public interface TModuleContentMapper {
    ...
    //查询一条content的对应的ID通过这个content的ID
    //select a module connect content id by this content's id
    ...
    //通过moduleID查询Lo表中的部分信息
    //select all LOs under each content.
